...
namespace NekoNinja
{
    ...
    struct ControllerSettings
    {
        ...
        ControllerSettings(const int& difficulty = 0, const std::wstring& backgroundImage = L"Data/Jobs/NekoPlace/Background/Park.jpg") : difficulty(difficulty), backgroundImage(backgroundImage) { }
    };
    struct Controller : Component
    {
        ...
        std::wstring backgroundImage{ L"Data/Jobs/NekoPlace/Background/Park.jpg" };
