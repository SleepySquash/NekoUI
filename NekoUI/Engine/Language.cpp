...
namespace ns
{
    ...
    void Language::Default()
    {
        ...
        dictionary["Exit"] = L"Exit";
        dictionary["Welcome to the"] = L"Welcome to the";
        dictionary["BACK"] = L"BACK";
        dictionary["Read"] = L"Read";
        dictionary["Account"] = L"Account";
        dictionary["Password"] = L"Password";
